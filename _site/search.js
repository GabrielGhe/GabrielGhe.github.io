...
temp = {
  ...
  "content" : "OverviewThis is how you overload an operator. More info can be found here.Normal 1 public class Complex { 2     public static Complex operator +(Complex c1, Complex c2)  3     { 4       return new Complex(c1.real + c2.real, c1.imaginary + c2.imaginary); 5     }    6 } 7  8 class Test { 9     static void Main(){10         Complex num1 = new Complex(2,3);11         Complex num2 = new Complex(3,4);12 13         // Add two Complex objects (num1 and num2) through the14         // overloaded plus operator:15         Complex sum = num1 + num2;16     } 17 }18 19 /*20  *  First complex number:  2 + 3i21  *  Second complex number: 3 + 4i22  *  The sum of the two numbers: 5 + 7i23  */Implicit and Explicit 1 // Implicit conversion from MyObject to string. Maps true to  2 // &quot;MyObject.Truthy&quot; and false to &quot;MyObject.Falsy&quot; 3  4 public class MyObject { 5     public static implicit operator string(MyObject x) { 6         return MyObject.value.ToString(); 7     } 8  9     // Implicit conversion from MyObject to int.10     public static explicit operator int(MyObject x) {11         return MyObject.value;12     }   13 }14 15 class Test {16     static void Main(){17         MyObject obj = new MyObject(5);18         Console.WriteLine(obj);         // implicit conversion to string19         Console.WriteLine( (int)obj );  // explicit conversion to int20     } 21 }22 23 /*24  *  525  *  526  */",
