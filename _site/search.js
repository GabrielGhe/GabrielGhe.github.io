...
temp = {
  ...
  "category": "csharp",
  "tags"    : "c# attributes",
  "content" : "OverviewAttributes can be used to add more information about a particular class in C#. This is an example (and code) of where you would use one. More info can be found here.Assigning 1 // Lets create an attribute that only works on classes that are used for databases 2 [System.AttributeUsage(System.AttributeTargets.Class)] 3 public class DatabaseAttribute : Attribute { 4     private string _url; 5     private int _id; 6     public string comment; 7  8     public DatabaseAttribute(string url, int id) { 9         this._url = url;10         this._id = id;11         comment = &quot;&quot;;12     }13 14     public string SayUrl() {15         return &quot;My url is &quot; + url;16     }17 }18 19 [Database(&quot;https://....&quot;, 1, &quot;My mongo database class&quot;)]20 public class MongoDB {21     // ...22 }Retrieving 1 // Given the code above 2  3 public class Program { 4     public static void Main(string[] args) { 5         // Get the attributes for MongoDB class, can have more than 1 6         System.Attribute[] attrs = System.Attribute.GetCustomAttributes(typeof(MongoDB)); // System.Type 7  8         // Display them 9         foreach (System.Attribute attr in attrs) {10             if (attr is Database) {11                 Database a = (Database)attr;12                 System.Console.WriteLine(&quot;{0} - {1}&quot;, a.SayUrl(), a.comment);13             }14         }15     }16 }17 18 // My url is https://.... - My mongo database classCool Applications of Attributes",
  "date"    : "January 22, 2015"
};
data[temp.id] = temp;
