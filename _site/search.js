...
temp = {
  ...
  "category": "javascript",
  "tags"    : "reactjs",
  "content" : "OverviewProperties can get passed down from a component to it’s children. Egghead VideoContentPart 1You can pass data to your component using properties. We added txt prop. 1 &lt;!doctype html&gt; 2 &lt;html lang=&quot;en&quot;&gt; 3 &lt;head&gt; 4     &lt;meta charset=&quot;UTF-8&quot;&gt; 5     &lt;title&gt;Setting Properties&lt;/title&gt; 6     &lt;script src=&quot;http://fb.me/react-0.8.0.js&quot;&gt;&lt;/script&gt; 7   &lt;script src=&quot;http://fb.me/JSXTransformer-0.8.0.js&quot;&gt;&lt;/script&gt; 8 &lt;/head&gt; 9 &lt;body&gt;10 &lt;script type=&quot;text/jsx&quot;&gt;11     /*** @jsx React.DOM */12     var APP = React.createClass({13         render:function(){14             console.log(this.props.txt)15             return (16                     &lt;div&gt;17                         &lt;h1&gt;{this.props.txt}&lt;/h1&gt;18                         &lt;b&gt;bold&lt;/b&gt;19                     &lt;/div&gt;20                     )21         }22     });23 24     React.renderComponent(&lt;APP txt=&quot;This is the txt prop&quot; /&gt;,document.body)25 &lt;/script&gt;26 &lt;/body&gt;27 &lt;/html&gt;Part 2You can also specify the props that you’re expecting using the propTypes property. By default, a propType is optional; however, if you add cat: React.PropTypes.number.isRequired then React will complain because it’s not one of the properties of App. If we add cat to the app initialization on line 18, it will work. 1 &lt;script type=&quot;text/jsx&quot;&gt; 2     /*** @jsx React.DOM */ 3     var App = React.createClass({ 4         propTypes:{ 5           txt: React.PropTypes.string, 6           cat: React.PropTypes.number.isRequired 7         }, 8         render:function(){ 9             return (10                     &lt;div&gt;11                         &lt;h1&gt;{this.props.txt}&lt;/h1&gt;12                         &lt;b&gt;bold&lt;/b&gt;13                     &lt;/div&gt;14                     )15         }16     });17 18     React.renderComponent(&lt;App cat={5} txt=&quot;This is the txt prop&quot; /&gt;,document.body)19 &lt;/script&gt;Part 3You can define the default properties for any component using the getDefaultProps property on the component.Which means the code below will work even though we don’t have cat and txt on on App initialization on line 24. 1 &lt;script type=&quot;text/jsx&quot;&gt; 2     /*** @jsx React.DOM */ 3     var App = React.createClass({ 4         getDefaultProps: function(){ 5           return { 6               txt: &quot;This is stuff&quot;, 7               cat: 0 8           }; 9         },10         propTypes:{11           txt: React.PropTypes.string,12           cat: React.PropTypes.number.isRequired13         },14         render:function(){15             return (16                     &lt;div&gt;17                         &lt;h1&gt;{this.props.txt}&lt;/h1&gt;18                         &lt;b&gt;bold&lt;/b&gt;19                     &lt;/div&gt;20                     )21         }22     });23 24     React.renderComponent(&lt;App /&gt;,document.body)25 &lt;/script&gt;",
