...
temp = {
  ...
  "content" : "I recently came across a guide to C# for Java developers. It is very detailed and clear and I think anyone who knows java and wants to know how C# is different should read it. Here’s the original .",
  "date"    : "January 26, 2015"
};
data[temp.id] = temp;
...
temp = {
  ...
  "content" : "OverviewHere’s a small table that shows the difference between abstract, sealed and static classes. See the example below. More info can be found here.1 /*2 +-------------------------+--------+--------+--------+----------+3 |       Class Type        | normal | static | sealed | abstract |4 +-------------------------+--------+--------+--------+----------+5 | Can be instantiated     | yes    | no     | yes    | no       |6 | Can be inherited        | yes    | no     | no     | yes      |7 | Can inherit from others | yes    | no     | yes    | yes      |8 +-------------------------+--------+--------+--------+----------+9  */",
